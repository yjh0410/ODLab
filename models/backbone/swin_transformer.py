...
model_urls = {
    'swin_t': 'https://github.com/yjh0410/ODLab/releases/download/backbone_weights/swin_tiny_patch4_window7_224_22k.pth',
    'swin_s': 'https://github.com/yjh0410/ODLab/releases/download/backbone_weights/swin_small_patch4_window7_224_22k.pth',
    'swin_b': None,
    'swin_l': None,
}
...
def built_swin_transformer(cfg, pretrained=False):
    # --------------- build Backbone ---------------
    out_indices = (1, 2, 3)
    if cfg['backbone'] == 'swin_t':
        backbone = SwinTransformer(
                ...
                window_size=7,
                ape=False,
                drop_path_rate=cfg['backbone_drop_rate'],
                patch_norm=True,
                use_checkpoint=True,
    ...
    output_dims = [backbone.embed_dim * 2,
                   backbone.embed_dim * 4,
                   backbone.embed_dim * 8]

    # --------------- load pretrained ---------------
    if pretrained:
        backbone = load_weight(cfg['backbone'], backbone) 

    return backbone, output_dims
...
if __name__ == '__main__':
    ...
    model, feat_dim = built_swin_transformer(cfg, cfg['pretrained'])
    print(feat_dim)
