...
def build_yolof_config(args):
    ...
    elif args.model == 'yolof_r18_c5_3x':
        return Yolof_R18_C5_3x_Config()
    elif args.model == 'yolof_r50_c5_3x':
        return Yolof_R50_C5_3x_Config()
    elif args.model == 'yolof_r101_c5_3x':
        return Yolof_R101_C5_3x_Config()
    ...
    elif args.model == 'yolof_r50_dc5_3x':
        return Yolof_R50_DC5_3x_Config()
    elif args.model == 'yolof_r101_dc5_3x':
        return Yolof_R101_DC5_3x_Config()
...
# -------------- 3x scheduler --------------
class Yolof_R18_C5_3x_Config(Yolof_R18_C5_1x_Config):
    def __init__(self) -> None:
        super().__init__()
        # --------- Train epoch ---------
...
class Yolof_R50_C5_3x_Config(Yolof_R18_C5_3x_Config):
    def __init__(self) -> None:
        super().__init__()
        # --------- Backbone ---------
        self.backbone = "resnet50"

class Yolof_R101_C5_3x_Config(Yolof_R18_C5_3x_Config):
    def __init__(self) -> None:
        super().__init__()
        # --------- Backbone ---------
        self.backbone = "resnet101"

class Yolof_R50_DC5_3x_Config(Yolof_R50_DC5_1x_Config):
    def __init__(self) -> None:
        super().__init__()
        # --------- Train epoch ---------
        self.max_epoch = 36         # 3x
...
class Yolof_R101_DC5_3x_Config(Yolof_R50_DC5_3x_Config):
    def __init__(self) -> None:
        super().__init__()
        # --------- Backbone ---------
        self.backbone = "resnet101"
