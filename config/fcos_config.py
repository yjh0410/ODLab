...
def build_fcos_config(args):
    ...
    elif args.model == 'fcos_r101_1x':
        return Fcos_R101_1x_Config()
    
    elif args.model == 'fcos_r18_3x':
        return Fcos_R18_3x_Config()
    elif args.model == 'fcos_r50_3x':
        return Fcos_R50_3x_Config()
    elif args.model == 'fcos_r101_3x':
        return Fcos_R101_3x_Config()
...
class Fcos_R101_1x_Config(Fcos_R18_1x_Config):
    def __init__(self) -> None:
        super().__init__()
        ## Backbone
...
class Fcos_R101_3x_Config(Fcos_R18_3x_Config):
    def __init__(self) -> None:
        super().__init__()
        ## Backbone
        self.backbone = "resnet101"
